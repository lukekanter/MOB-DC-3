...
class SecondViewController: ExerciseViewController {
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        square4.backgroundColor = .greenColor()
        ...
        NSLayoutConstraint.constraintsWithVisualFormat("H:|[square1(width)]",
            options: NSLayoutFormatOptions.AlignAllLeft,
            metrics: metrics,
            views: views)
        
        let square1HeightConstraints =
        NSLayoutConstraint.constraintsWithVisualFormat("V:|[square1(height)]",
        ...
        let square2WidthConstraints =
            NSLayoutConstraint.constraintsWithVisualFormat("H:[square2(width)]|",
                options: NSLayoutFormatOptions.AlignAllRight,
                metrics: metrics,
                views: views)
        
        let square2HeightConstraints =
        NSLayoutConstraint.constraintsWithVisualFormat("V:|[square2(height)]",
            options: NSLayoutFormatOptions.AlignAllTop,
            metrics: metrics,
            views: views)
        ...
        NSLayoutConstraint.constraintsWithVisualFormat("H:|[square3(width)]",
            options: NSLayoutFormatOptions.AlignAllLeft,
            metrics: metrics,
            views: views)
        
        let square3HeightConstraints =
        NSLayoutConstraint.constraintsWithVisualFormat("V:[square3(height)]-(44)-|",
        ...
        NSLayoutConstraint.constraintsWithVisualFormat("H:[square4(width)]|",
            options: NSLayoutFormatOptions.AlignAllRight,
            metrics: metrics,
            views: views)
        
        let square4HeightConstraints =
        NSLayoutConstraint.constraintsWithVisualFormat("V:[square4(height)]-(44)-|",
            options: NSLayoutFormatOptions.AlignAllBottom,
            metrics: metrics,
            views: views)
